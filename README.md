...
本仓库用于小组协作完成强化学习课程大作业。课题目标是使用 DQN 系列模型解决众包系统中的任务推荐问题，并分别从参与者利益和请求者利益两个角度设计实验、训练模型并分析结果。
...
5. 实验结果、关键参数和结论需要记录到 `reports/` 或 Pull Request 描述中。
